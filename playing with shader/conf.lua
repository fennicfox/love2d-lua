function love.conf(t)
    t.identity = "fading effect"        -- The name of the save directory (string)
    ...
    t.accelerometerjoystick = false      -- Enabl#e the accelerometer on iOS and Android by exposing it as a Joystick (boolean)
    t.externalstorage = false           -- True to save files (and read from the save directory) in external storage on Android (boolean) 
    t.gammacorrect = true               -- Enable gamma-correct rendering, when supported by the system (boolean)
 
    t.window.title = "Oli"              -- The window title (string)
