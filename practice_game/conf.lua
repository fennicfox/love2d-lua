function love.conf(t)
	...
	t.title             = "Practice Game" -- The title of the window the game is in (string)
	t.author            = "Oliver Legg"   -- The author of the game (string)
	...
	--t.window.icon     = ""              -- Changes the window icon
