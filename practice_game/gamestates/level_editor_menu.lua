...
function level_editor_menu_load(  )
	...
	lvl_button_export 		= button:create(windowWidth, windowHeight+40, colour, newColour, "font/SourceSansPro-Light.ttf", 32, "export",       to_export							 )
	lvl_button_quit 		= button:create(windowWidth, windowHeight+80, colour, newColour, "font/SourceSansPro-Light.ttf", 32, "quit",         function() gamestate="main_menu" end)
...
function level_editor_menu_resize(w, h)
	if level_editor_menu_state == "main" then
		...
		lvl_button_export:changePos(     w/2,    h/2+40  )
		lvl_button_quit:changePos(       w/2,    h/2+80  )
	elseif level_editor_menu_state == "save" then
